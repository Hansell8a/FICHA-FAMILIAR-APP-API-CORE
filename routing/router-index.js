...
var accesoServicioSaludController = require('../controllers/accesoServicioSaludController');
var antecedenteNutricionalController = require('../controllers/antecedenteNutricionalController');
...
router.use('/acceso-servicio-salud', accesoServicioSaludController);
router.use('/antecedente-nutricional', antecedenteNutricionalController);
