    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            const objeto = {
                ...
                id_material_techo: parametros.id_material_techo ? parseInt(parametros.id_material_techo) : 0,
...
exports.insertarDetalleUnificado = (req, parametros, method) => {
    return new Promise((resolve, reject) => {
        try {
            var usuario = obtenerUsuario(req);
            const objeto = {
            ...
            var reponse = oraServices.insertarDetalleUnificado(objeto, method);
            return resolve(reponse);
        } catch (ex) {
            return reject(ex);
        }
