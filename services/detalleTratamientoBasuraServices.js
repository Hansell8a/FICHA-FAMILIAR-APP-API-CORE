...
var oraServices = require("../db_apis/detalleTratamientoBasuraDB");

exports.obtener = (req, parametros, method) => {
    return new Promise((resolve, reject) => {
        try {
            const objeto = {
                id_detalle_tratamiento_basura: parametros.id_detalle_tratamiento_basura ? parseInt(parametros.id_detalle_tratamiento_basura) : 0,
