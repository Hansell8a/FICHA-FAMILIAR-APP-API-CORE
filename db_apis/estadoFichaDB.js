...
const { rowMapper } = require('../mapper/estadoFichaRowsMapper');

module.exports.obtener = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.ESTADO_FICHA.OBTENER}(` +
                `:pIdEstadoFicha,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.insertar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.ESTADO_FICHA.INSERTAR}(` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
...
module.exports.actualizar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.ESTADO_FICHA.ACTUALIZAR}(` +
                `:pIdEstadoFicha,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.eliminar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.ESTADO_FICHA.ELIMINAR}(` +
                `:pIdEstadoFicha,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
