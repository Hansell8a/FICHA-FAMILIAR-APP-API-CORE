...
const { rowMapper } = require('../mapper/tratamientoAguaGris');

module.exports.obtener = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TRATAMIENTO_AGUA_GRIS.OBTENER}(` +
...
module.exports.insertar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TRATAMIENTO_AGUA_GRIS.INSERTAR}(` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
...
module.exports.actualizar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TRATAMIENTO_AGUA_GRIS.ACTUALIZAR}(` +
                `:pIdTratamientoAguaGris,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.eliminar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TRATAMIENTO_AGUA_GRIS.ELIMINAR}(` +
                `:pIdTratamientoAguaGris,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
