...
const { rowMapper } = require('../mapper/materialTechoRowsMapper');

module.exports.obtener = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.MATERIAL_TECHO.OBTENER}(` +
                `:pIdMaterialTecho,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.insertar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.MATERIAL_TECHO.INSERTAR}(` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
...
module.exports.actualizar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.MATERIAL_TECHO.ACTUALIZAR}(` +
                `:pIdMaterialTecho,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.eliminar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.MATERIAL_TECHO.ELIMINAR}(` +
                `:pIdMaterialTecho,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
