...
const { rowMapper } = require('../mapper/tenenciaViviendaRowsMapper');

module.exports.obtener = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TENENCIA_VIVIENDA.OBTENER}(` +
                `:pIdTenenciaVivienda,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.insertar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TENENCIA_VIVIENDA.INSERTAR}(` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
...
module.exports.actualizar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TENENCIA_VIVIENDA.ACTUALIZAR}(` +
                `:pIdTenenciaVivienda,` +
                `:pDescripcion,` +
                `:pIdUsuarioRegistro,` +
                /** */
...
module.exports.eliminar  = (parametros,method) => {
    return new Promise(async (resolve, reject) => {
        try {
            var plsql = `${PACKAGES.PACKAGE}.${PROCEDURES.TENENCIA_VIVIENDA.ELIMINAR}(` +
                `:pIdTenenciaVivienda,` +
                `:pIdUsuarioRegistro,` +
                /** */
                `:pCursor,` +
